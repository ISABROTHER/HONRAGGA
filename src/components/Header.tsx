...
export function Header({ currentPage, onNavigate }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-xl transition-shadow relative">
      ...
      {/* Mobile Menu Dropdown OVERLAY - ADDED BLURRED GLASS EFFECT */}
      <div
        className={`md:hidden absolute inset-x-0 top-full w-full bg-white/95 backdrop-blur-lg border-t border-gray-200 shadow-2xl overflow-hidden
