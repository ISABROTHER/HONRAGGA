          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <div className="px-6 py-3 bg-slate-50 rounded-2xl border border-slate-100">
                <h4 className="font-black text-slate-900 uppercase text-[10px] tracking-widest mb-1">Office</h4>
        ...
        <div className="mt-40">
          <div className="mb-12 border-b border-gray-100 pb-6 flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-500 font-medium mt-2 uppercase text-[10px] tracking-widest">Grassroots Representatives of Cape Coast North</p>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            {LOCATIONS.map((member) => (
              <div
                key={member.zone}
                className="flex flex-col items-center text-center group bg-white border border-gray-100 rounded-2xl p-3 hover:shadow-xl transition-all duration-300"
              >
                ...
                <div className="w-full">
                  ...
                  <p className="text-sm font-black text-slate-900 leading-tight uppercase line-clamp-2 mb-1">
                    {member.assemblyman}
                  </p>
