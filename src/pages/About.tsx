  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* --- SECTION 1: THE PREMIUM HERO (5 HOURS AGO DESIGN) --- */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
          ...
          <div className="space-y-8 animate-fade-in">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-100">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-700">Official Profile</span>
            </div>
            
            <div className="space-y-6">
              <h1 className="text-4xl md:text-7xl font-black text-slate-900 leading-[0.9] tracking-tighter uppercase">
                Hon. Dr. Kwamena <br />
          ...
          <div className="relative group">
            ...
            <div className="absolute -top-10 -right-10 w-72 h-72 bg-blue-50 rounded-full blur-3xl opacity-60" />
            
            {/* Main Image Frame */}
            <div className="relative aspect-[4/5] rounded-[3rem] overflow-hidden shadow-2xl border-8 border-white group-hover:scale-[1.01] transition-transform duration-700">
              <img 
                src={mpPortraitUrl} 
            ...
            <div className="absolute -bottom-8 -right-4 md:-right-8 bg-slate-900 text-white p-8 md:p-12 rounded-[2.5rem] shadow-2xl transform hover:-translate-y-2 transition-transform duration-300">
              <div className="relative z-10">
                <p className="text-5xl md:text-6xl font-black mb-1 italic tracking-tighter">"Ragga"</p>
                <div className="h-1.5 w-16 bg-blue-500 mb-4 rounded-full" />
                <p className="text-blue-400 font-bold uppercase tracking-[0.4em] text-[10px]">Verifiable Action</p>
              </div>
              <Award className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 text-white/5 pointer-events-none" />
            </div>
          </div>
        </div>

        {/* --- SECTION 2: THE LEADERSHIP GRID (ASSEMBLYMEN) --- */}
        <div className="mt-20">
          <div className="mb-12 border-b border-gray-100 pb-8 flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-500 font-bold mt-2 uppercase text-[10px] tracking-[0.3em]">Grassroots Representatives • Cape Coast North</p>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8">
            {LOCATIONS.map((member) => (
              <div
                key={member.zone}
                className="flex flex-col items-center text-center group bg-white border border-slate-50 rounded-3xl p-4 hover:shadow-2xl transition-all duration-500 hover:-translate-y-1"
              >
                <div className="w-full aspect-[3/4] bg-slate-100 overflow-hidden rounded-2xl mb-4 relative">
                  <img 
                    src={member.photoUrl} 
                ...
                <div className="w-full">
                  ...
                  <p className="text-sm font-black text-slate-900 leading-tight uppercase line-clamp-2 mb-2">
                    {member.assemblyman}
                  </p>
                  <div className="flex items-center justify-center gap-2">
                    ...
                    <span className="text-xs font-bold text-slate-500">{formatPhoneNumber(member.phone)}</span>
                  </div>
                </div>
              </div>
            ))}
