...
import { 
  ...
  DollarSign, Bell, ChevronRight, LogOut, Menu as MenuIcon, X
} from 'lucide-react';
...
export function Admin() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex font-sans pb-20 lg:pb-0"> {/* Added padding-bottom for mobile nav */}
