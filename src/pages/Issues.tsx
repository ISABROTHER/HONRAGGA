...
export function Issues() {
  ...
  const onSubmitIssue = async (e: React.FormEvent) => {
    ...
    if (!selectedZone || !selectedCommunity) {
      setErrorMsg('Please select your Zone and Community.');
      return;
    }
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2 space-y-4">
                   ...
                   <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        >
                          ...
                          {selectedZone && LOCATIONS[selectedZone as keyof typeof LOCATIONS].map((comm) => (
                   ...
                   <div>
                      <label className="block text-sm font-medium text-gray-800 mb-1">Specific Landmark (Optional)</label>
                ...
                {/* CONTACT INFO */}
                <div className="md:col-span-2 space-y-4">
                   <h3 className="text-lg font-bold text-slate-900 border-b pb-2">Your Details (Optional)</h3>
                   <div className="grid md:grid-cols-2 gap-4">
                      <div>
