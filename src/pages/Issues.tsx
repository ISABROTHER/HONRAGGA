...
export function Issues() {
  ...
  const filteredCommunities = selectedZone 
    ? LOCATIONS[selectedZone].filter(c => c.toLowerCase().includes(communitySearch.toLowerCase()))
    : [];

  // Completion Checks for Sections
            ...
            >
              <div className="p-6 md:p-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {/* Area (Zone) Selector */}
                  <div>
                    <label className="block text-sm font-medium text-blue-800 mb-1">Area (Zone) *</label>
