                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 bg-white/80 backdrop-blur-md p-6 md:p-8 rounded-2xl shadow-xl border border-gray-100">
                            ...
                            <div>
                                ...
                                {showContactInfo && (
                                    ...
                                    >
                                         <input type="text" name="contactName" value={reportData.contactName} onChange={handleInputChange} placeholder="Your Name" className="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF6B00] focus: