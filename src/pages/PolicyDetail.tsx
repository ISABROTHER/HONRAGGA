...
export function Policies({ onSelectTheme }: PoliciesProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Section Header - Base Image and Gradient ONLY */}
      <section className="relative w-full overflow-hidden min-h-[250px] sm:min-h-[350px]"> {/* Removed flex items-end justify-center pb-12 sm:pb-16 */}
        {/* Base Image */}
        <img
          src={headerImageUrl}
        ...
        {/* Text Overlay (INITIATIVES and BY RAGGA) has been removed */}
      </section>
