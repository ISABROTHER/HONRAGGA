...
const quickLinks: QuickLink[] = [
  ...
  {
    title: "Assembly Members", // Renamed from Policies
        ...
        <div className="grid grid-cols-3 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-8 lg:gap-10">
          {quickLinks.map((link, idx) => (
            <button
              ...
              className={`group relative overflow-hidden rounded-xl md:rounded-3xl border ${link.bgClass} bg-gradient-to-br p-3 md:p-10 flex flex-col items-center text-center cursor-pointer hover:shadow-xl hover:-translate-y-2 active:scale-95 transition-all`}
            >
              <div className="w-12 h-12 md:w-20 md:h-20 bg-white rounded-xl md:rounded-3xl flex items-center justify-center shadow-sm mb-2 md:mb-6 group-hover:scale-110 transition-transform">
