      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative bg-white text-gray-900 rounded-2xl shadow-2xl max-w-md w-full overflow-hidden"
          ...
          >
            ...
            <div className="p-6 relative">
              ...
              <h2 className="text-2xl font-extrabold text-[#0f5132] mb-2 text-center tracking-tight">
                Confirm Contribution
              </h2>

              <div className="my-5 text-center bg-gray-50 p-4 rounded-xl border border-gray-200 shadow-sm">
                <p className="text-sm text-gray-600">You are contributing</p>
                <p className="text-3xl font-black text-[#0f5132] my-1">{formatCurrencyModal(amount)}</p>
              ...
              >
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full text-base pl-9 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF6B00] focus:border-transparent bg-white text-gray-900"
                ...
                <div className="space-y-2 pt-2">
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <label htmlFor="showPublicly" className="text-sm text-gray-700 cursor-pointer select-none">
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      className="h-4 w-4 rounded border-gray-300 text-[#FF6B00] focus:ring-[#FF6B00]/50"
                    />
                    <label htmlFor="showAmountPublicly" className="text-sm text-gray-700 cursor-pointer select-none">
                ...
                <div className="relative">
                  {/* animated aura behind button */}
                  <div className="absolute -inset-1 rounded-2xl bg-gradient-to-r from-[#FF6B00] via-amber-400 to-[#FF6B00] opacity-30 blur transition duration-500" />
                  <Button
                    type="submit"
                    size="lg"
                    className="relative w-full bg-[#FF6B00] hover:bg-[#E66000] focus:ring-[#FF6B00] text-white shadow-lg flex items-center justify-center mt-4 rounded-2xl"
...
export function Volunteer() {
  ...
  // Faux progress (percent only as requested)
  ...
  return (
    ...
    >
      ...
      <section className="relative overflow-hidden bg-[#002B5B] text-white py-16 md:py-24">
        ...
        <AnimatedSection>
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-3 md:mb-4">
      ...
      {/* DONATE SECTION with gradient frame */}
      <section id="donate" className="py-12 md:py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection delay={80}>
            {/* gradient border wrapper */}
            <div className="rounded-3xl p-[1px] bg-gradient-to-br from-[#FF6B00] via-amber-300/60 to-[#002B5B] shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
              <form
                ref={formRef}
                onSubmit={handleDonateSubmit}
                aria-labelledby="donate-form-heading"
                className="rounded-3xl bg-white/90 backdrop-blur p-5 md:p-8 space-y-7"
              >
                <h2 id="donate-form-heading" className="sr-only">
                  Donation Form
                </h2>

                {/* Pillar chips (scrollable) */}
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2 overflow-auto no-scrollbar py-1">
                    {pillars.map((p) => {
                      ...
                      return (
                        <button
                          ...
                          type="button"
                          onClick={() =>
                            setDonationForm((prev) => ({ ...prev, selectedPillar: p.slug }))
                          }
                          className={[
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        setDonationForm((prev) => ({ ...prev, selectedPillar: 'general' }))
                      }
                      className={[
                        'whitespace-nowrap px-3 py-2 rounded-full border text-sm transition-all',
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <label className="block text-sm font-medium text-gray-800">Donation Amount</label>
                    <div className="flex items-center gap-2">
                      ...
                      <select
                        ...
                        className="text-xs border border-gray-300 rounded px-2 py-1 focus:ring-1 focus:ring-[#FF6B00] focus:outline-none"
                      >
                  ...
                  <div
                    ...
                    className="grid grid-cols-2 sm:grid-cols-3 gap-3 md:gap-4 mb-4"
                  >
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full text-base pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#FF6B00] focus:border-transparent bg-white text-gray-900"
                ...
                {/* Payment Method */}
                <div>
                  <p className="text-sm font-medium text-gray-800 mb-2">Choose Payment Method</p>
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    {currency === 'USD' ? (
                      ...
                      <div className="w-full rounded-xl px-4 py-3 border border-dashed border-gray-300 text-gray-400 text-center text-sm">
                         Apple&nbsp;Pay (USD only)
                      </div>
                    )}
                  </div>
                  <p className="mt-2 text-xs text-gray-500">
                    Using Visa/Mastercard? Select <span className="font-semibold">Paystack</span>. For GHS, Paystack
                    (MoMo/Card) is required.
                  </p>
                </div>
                ...
                <div className="grid gap-3 md:grid-cols-2">
                  <div className="flex items-center justify-between bg-gray-50 border border-gray-200 rounded-xl p-3">
                    <label htmlFor="recurring" className="text-sm font-medium text-gray-800">
                  ...
                  <label className="flex items-center gap-2 text-sm text-gray-700 pl-1 cursor-pointer">
                    <input
                      ...
                      className="h-4 w-4 accent-[#FF6B00] rounded border-gray-300"
                    />
                ...
                {/* Desktop/Tablet CTA with glow aura */}
                <div className="relative hidden md:block">
                  ...
                  <Button
                    type="submit"
                    size="lg"
                    className={`relative w-full bg-[#FF6B00] hover:bg-[#E66000] focus:ring-[#FF6B00] text-white shadow-lg items-center justify-center rounded-2xl ${
                      hasValidAmount ? '' : 'opacity-60 cursor-not-allowed'
                    }`}
                    disabled={!hasValidAmount}
                    aria-disabled={!hasValidAmount}
                    aria-label={`Contribute ${fmt(donationForm.amount)} with ${
                      paymentMethod === 'applePay' ? 'Apple Pay' : 'Paystack'
                    }`}
                  >
                    <Gift className="w-5 h-5 mr-2" />
          ...
          <AnimatedSection delay={140}>
            <div className="mt-12 md:mt-16">
              <div className="flex flex-col sm:flex-row justify-between items-center mb-4 md:mb-6 px-1">
                <h3 className="text-2xl md:text-3xl font-bold text-[#002B5B] mb-3 sm:mb-0 tracking-tight">
                  Recent Contributions
                </h3>
                ...
                <div role="list" className="space-y-3 md:space-y-4 max-w-lg mx-auto">
                  {filteredDonations.map((donation) => (
                    <motion.div
                      ...
                      className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm flex justify-between items-center hover:bg-[#FF6B00]/5 transition-colors"
                    >
                      <div className="pr-3">
      ...
      <div className="md:hidden fixed bottom-20 inset-x-4 z-40 text-center text-xs text-gray-700">
        {hasValidAmount ? (
          <div className="bg-white/90 backdrop-blur border border-gray-200 rounded-full px-3 py-2 shadow">
            {fmt(donationForm.amount)} •{' '}
            {getPillarTitleFromSlug(donationForm.selectedPillar).split(' (')[0]}
      ...
      <div className="md:hidden fixed bottom-4 inset-x-4 z-40">
        <div className="relative">
          ...
          <Button
            ...
            size="lg"
            onClick={submitForm}
            className={`relative w-full rounded-2xl shadow-xl bg-[#FF6B00] hover:bg-[#E66000] focus:ring-[#FF6B00] text-white flex items-center justify-center ${
              hasValidAmount ? '' : 'opacity-60 cursor-not-allowed'
            }`}
            disabled={!hasValidAmount}
            aria-disabled={!hasValidAmount}
      ...
      <style>{`
        ...
        /* Hide horizontal scrollbar on chips (where supported) */
