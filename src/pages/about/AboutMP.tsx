...
import { 
  ...
  CheckSquare, Users, Landmark, Eye, ChevronDown, ChevronUp
} from 'lucide-react';
            ...
            <div className="flex-1 space-y-4">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="group flex items-center gap-2 px-6 py-3 bg-blue-900 text-white text-sm font-bold rounded-xl shadow-md hover:bg-blue-800 transition-all active:scale-95"
                >
                  {showFullProfile ? 'Show Less' : 'Read Full Profile'}
                  {showFullProfile ? <ChevronUp className="w-4 h-4" /> : <ChevronDown className="w-4 h-4 group-hover:translate-y-0.5 transition-transform" />}
                </button>
              </div>
            </div>
          </div>
        ...
        <AnimatePresence>
            {showFullProfile && (
                <motion.div
                    ...
                    className="overflow-hidden space-y-16 pt-12"
                >
                    ...
                    <div className="flex justify-center pt-8">
                        <button
                            ...
                            className="text-sm font-semibold text-gray-500 hover:text-blue-900 flex items-center gap-1"
                        >
