const initiatives = [
  {
    ...
    info: "Implementation of a comprehensive assistance program for senior high students across the constituency.",
    image: "https://i.imgur.com/Ozjnrli.jpeg"
  },
  {
    title: "Adisadel College Lighting",
    info: "Donation of 500 LED bulbs to alleviate lighting challenges in classrooms and dormitories.",
    image: "https://i.imgur.com/Ozjnrli.jpeg"
  },
  {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      {initiatives.map((item, idx) => (
        <div key={idx} className="bg-white rounded-3xl overflow-hidden border border-slate-100 shadow-lg">
          {/* 1. Picture */}
