  ...
  return (
    <section className="py-16 md:py-24 bg-slate-50 border-t border-slate-200 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* HEADER BLOCK (Matching Newsletter & Constituency Services Vibe) */}
        <div className="flex flex-col items-center mb-12 md:mb-16 text-center">
          
          {/* Eyebrow Pill - Green style for light background */}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white text-slate-900 rounded-3xl overflow-hidden shadow-xl border border-slate-100 flex flex-col md:flex-row group hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="md:w-1/2 relative h-64 md:h-auto overflow-hidden">
              ...
              />
              {/* Slight overlay for text contrast if needed, mostly clear for light theme */}
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent md:bg-gradient-to-r"></div>
              
              <div className="absolute bottom-6 left-6 text-white">
                <div className="inline-flex items-center gap-1.5 bg-amber-500 text-white px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider mb-2 shadow-sm">
            ...
            <div className="flex-1 p-8 md:p-10 flex flex-col justify-center">
              ...
              <div className="mb-8 p-5 bg-slate-50 rounded-2xl border border-slate-100">
                <div className="flex justify-between items-baseline mb-2">
                  <span className="text-2xl font-bold text-slate-900">325,000 <span className="text-sm font-medium text-slate-500">books raised</span></span>
                  <span className="text-sm font-bold text-green-600 bg-green-100 px-2 py-1 rounded-lg">65%</span>
                </div>
                <div className="w-full bg-slate-200 rounded-full h-3 overflow-hidden">
                  <div className="bg-gradient-to-r from-green-500 to-emerald-600 h-3 rounded-full w-[65%] shadow-sm relative overflow-hidden">
                    <div className="absolute inset-0 bg-white/20 w-full h-full animate-[shimmer_2s_infinite] -skew-x-12"></div>
                  </div>
                </div>
                <div className="mt-2 text-xs text-slate-500 text-right">Target: 500,000 books</div>
              </div>

              <Button 
                onClick={() => onNavigate('volunteer')}
                size="lg"
                className="w-full justify-center bg-gradient-to-r from-slate-900 to-slate-800 hover:from-slate-800 hover:to-slate-700 text-white py-4 text-lg shadow-xl shadow-slate-900/10"
              >
